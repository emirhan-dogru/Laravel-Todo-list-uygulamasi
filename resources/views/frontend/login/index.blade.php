    ...
    <div class="omb_login">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="omb_authTitle">Giriş Yap veya <a href="{{ route('user.Register') }}">Kaydol</a></h3>
            </div>
            <div class="card-body">
                <form class="omb_loginForm" action="{{ route('user.Auth')  }}" autocomplete="off" method="POST">
                    @csrf
                    ...
                    <div class="row omb_row-sm-offset-3">
                        ...
                        <div class="col-xs-12 col-sm-3">
                            <p class="omb_forgotPwd">
                                <a href="{{ route('admin.Login') }}">Yönetici Girişi</a>
                            </p>
                        </div>
                    </div>
                </form>
